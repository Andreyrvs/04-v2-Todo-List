...
// const catchTask = document.querySelectorAll('.task');

// catchTask.addEventListener('click', (event) => {
//   // const catchTask = document.querySelectorAll('.task');
//   for (let index = 0; index < catchTask.length; index += 1) {
//     catchTask[index].classList.remove('task');
//   }
//   event.target.classList.add('task');
//   createLi();
// });
// // Troca a cor de fundo ao Clicar na Tarefa

// function PegaCss() {
//   const catchTask = document.querySelector('#lista-tarefas');
//   const theCssprop = window
//   .getComputedStyle(catchTask, null)
